...
export const EditSchedule = props => {
    ...
    const initSchedule = {
         ...
         scheduleName: props.currentSelectedData.title,
    ...
    return (
        <Modal size="md" className="confirmationPopup" keyboard={true} show={props.show}>
          <Modal.Body className="p-3">
            <Image onClick={() => props.handleEditScheduleShowHide()} className='fl-right' src={close} alt="Logo"></Image>
            <Row>
              <Col xl={12} xs={12} className="text-center">
                <h5 className="title">EDIT SCHEDULE</h5>
            ...
            <Row>
              <Col className="text-center PrimaryBtn">
                <Button variant="primary" className="my-2" onClick={() => props.handleEditSchedule(scheduleFormData)}>Submit</Button>
              </Col>
            </Row>
          </Modal.Body>
        </Modal>
