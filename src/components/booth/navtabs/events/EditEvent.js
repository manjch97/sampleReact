...
export const EditEvent = (props) => {
  ...
  let eventCheckbox = false;
    const initEvent = {
         id: props.currentSelectedData.id,
         eventName: props.currentSelectedData.title,
         company: props.currentSelectedData.company,
         timeSlotFrom: props.currentSelectedData.start,
         timeSlotTo: props.currentSelectedData.end,
         minStartTime: props.calculateStartDateMinTime(new Date()),
         minEndTime: props.calculateEndDateMinTime(new Date(), new Date()),
         notes: props.currentSelectedData.notes,
         fileInput: null,
         resource: props.currentSelectedData.resource
    };
    ...
    const handleChange = event => {
      ...
      setFormData({
        ...eventFormData,
        [event.target.id]: fileUploaded,resource:null
      });
    };
    ...
    return (
        <Modal size="lg" className="confirmationPopup" keyboard={true} show={props.show} onHide={props.handleEditEventShowHide}>
          ...
          <Modal.Body className="pt-0"> 
            ...
            <Row>
              ...
              <h5 className="title">EDIT EVENT</h5>
            ...
            <Row>
              ...
              <Col md={6} className="mb-4">
                ...
                eventFormData.resource === null || eventFormData.resource === undefined ?
                <small className="text-16 gray3">Image</small>:
                <img src={eventFormData.resource} alt="selected-img" className="w-20px"/>:
            ...
            <Row>
              <Col className="text-right PrimaryBtn sm-eventpopup-btn p-sm-1 p-lg-3 p-md-2" xs={6}>
                <Button variant="primary" className="my-2 mx-xs-1 " onClick={() => props.handleEditEvent(eventFormData)}>Submit</Button>
              </Col>
              <Col className="text-left BlackBtn sm-eventpopup-btn p-sm-1 p-lg-3 p-md-2" xs={6}>
                <Button variant="Black" className="my-2 mx-xs-1 " onClick={props.handleEditEventShowHide} >Delete</Button>
              </Col>
            </Row>
            </Col>
          </Modal.Body>
